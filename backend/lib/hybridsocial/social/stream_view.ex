defmodule Hybridsocial.Social.StreamView do
  ...
  # The value the client sends in `source`. `streams_feed` is what the Streams
  # player actually posts; omitting it rejected every view that feed recorded
  # (422 validation.failed), so view tracking silently never worked. `feed` is
  # the generic fallback.
  @valid_sources ~w(feed streams_feed profile trending direct_link)
