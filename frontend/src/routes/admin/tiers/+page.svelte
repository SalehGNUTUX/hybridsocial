<script lang="ts">
  ...
  const limitRows = [
    ...
    { key: 'audio_allowed', label: 'Audio posts allowed', type: 'boolean' },
    { key: 'audio_size_mb', label: 'Audio size (MB)', type: 'integer' },
    { key: 'audio_duration', label: 'Audio duration (sec)', type: 'integer' },
