<script lang="ts">
  ...
  const navGroups: NavItem[][] = [
    ...
    [
      ...
      { href: '/streams', labelKey: 'nav.streams', icon: 'M5 3l14 9-14 9V3z' },
      { href: '/reels', labelKey: 'nav.reels', icon: 'M3 5h18v14H3z M3 9h18 M8 5v4 M13 5v4 M18 5v4 M10 13l4 2-4 2z' },
    ],
    [
