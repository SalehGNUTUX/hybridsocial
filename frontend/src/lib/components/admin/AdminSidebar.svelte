<script lang="ts">
  ...
  const allNavItems: AdminNavItem[] = [
    ...
    { href: '/admin/premium-reactions', label: 'Premium Reactions', icon: 'M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z', permission: 'settings.manage' },
